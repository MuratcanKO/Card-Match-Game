public static class GlobalConstants
{
    ...
    public const string CARD_ANIMATOR_WRONG_NAME = "Wrong";
    public const string CARD_ANIMATOR_CORRECT_NAME = "Correct";
    public const string CARD_ANIMATOR_REMOVE_NAME = "Remove";
    public const string CARD_ANIMATOR_SPAWN_NAME = "Spawn";
    public const string CARD_ANIMATOR_SELECT_NAME = "Select";
    public const string CARD_ANIMATOR_UNSELECT_NAME = "Unselect";
}
